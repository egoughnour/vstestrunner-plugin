...
public class InjectedTest extends junit.framework.TestCase {
  public static junit.framework.Test suite() throws Exception {
    ...
    parameters.put("basedir","C:\\src\\eclipse\\workspace\\vstestrunner-plugin");
    parameters.put("artifactId","vstestrunner");
    parameters.put("outputDirectory","C:\\src\\eclipse\\workspace\\vstestrunner-plugin\\target\\classes");
    parameters.put("testOutputDirectory","C:\\src\\eclipse\\workspace\\vstestrunner-plugin\\target\\test-classes");
